 ...
 */
public class CodePasswordActivity extends Activity {
    ...
    void btn_finish(View v) {
        startActivity(new Intent(CodePasswordActivity.this, RegisterActivity.class).setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP));
        this.finish();
    }
    ...
    void btn_next(View v) {
        ...
        Intent intent = new Intent(CodePasswordActivity.this, Perfect_information.class).putExtra("pwd", repwd).putExtra("username", UserName).setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
