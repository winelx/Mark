...
public class Add_Person extends Activity {
    ...
    private int bust_add;
    private int waist_add;
    private int hipline_add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = (String) SharedUtil.getParam(Add_Person.this, "userid", "");
...
//                textHeight.setText("身高" + Integer.toString(progress) + "cm");
                textHeight.setText("身高" + height_add + "cm");
                //身高
                height = height_add;
            }
     ...
     */
    private void requst() {
        final ProgressDialog mDialog = ProgressDialog.show(Add_Person.this, "提交信息", "提交中...");
        OkGo.post(Contants.ADD_PERSON)
                .params("userId", SharedUtil.getParam(Add_Person.this,"userid","").toString())
                .params("photo", portrait)
                .params("nickname", nickName)
                .params("sex", sex)
                .params("weight", weight)
                .params("height", height)
                .params("bust", bust)
                .params("waistline", waist)
                .params("hipline", hipline)
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            ...
                            if (s.indexOf("error") != -1) {//有错误
                                Toast.makeText(Add_Person.this, json.getString("error"), Toast.LENGTH_SHORT).show();
                                return;
                            }
                            Toast.makeText(Add_Person.this, "提交成功", Toast.LENGTH_SHORT).show();
                            finish();
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        mDialog.dismiss();
                        Toast.makeText(Add_Person.this, e.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//            photo(portrait);
    ...
    @OnClick({R.id.image_height_reduce, R.id.image_height_add, R.id.image_weight_reduce,
            R.id.image_weight_add, R.id.image_bust_reduce, R.id.image_bust_add, R.id.image_waist_reduce,
            R.id.image_waist_add, R.id.image_hipline_reduce, R.id.image_hipline_add})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.image_weight_reduce:
                Weight_add --;
                textWeight.setText("体重" + Weight_add + "kg");
                weight = Weight_add;
                break;
            ...
            case R.id.image_bust_reduce:
                bust_add --;
                textBust.setText("胸围" + bust_add + "cm");
                //胸围
                bust = bust_add;
                break;
            ...
            case R.id.image_waist_reduce:
                waist_add --;
                textWaist.setText("腰围" + waist_add + "cm");
                //腰围
                waist = waist_add;
                break;
            ...
            case R.id.image_hipline_reduce:
                hipline_add --;
                textHipline.setText("臀围" + hipline_add + "cm");
                //臀围
                hipline = hipline_add;
                break;
