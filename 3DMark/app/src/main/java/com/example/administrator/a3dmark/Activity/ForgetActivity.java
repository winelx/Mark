...
import com.example.administrator.a3dmark.bean.Color;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_code:
                ...
                OkGo.post(Contants.MESSAGE_CODE)//修改密码验证码接口
                        .tag(this)
                        .params("phone", phone)
                            ...
                            public void onSuccess(String s, Call call, Response response) {
                                ...
                                try {
                                    ...
                                    if(s.indexOf("error") != -1){//有错误
                                        Toast.makeText(ForgetActivity.this, jsonObject.getString("error"), Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                    time.start();//计时器
            ...
            case R.id.btn_next_register:
                ...
                //去重置密码
                startActivity(new Intent(this, ResetPasswordActivity.class).putExtra("reset_username", phone));
                this.finish();
                break;
