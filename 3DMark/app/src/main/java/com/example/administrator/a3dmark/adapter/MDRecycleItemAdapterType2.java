 ...
 */
public class MDRecycleItemAdapterType2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<MDStore>  results;

    //get & set
    public List<MDStore> getResults() {
        return results;
    }
    ...
    public MDRecycleItemAdapterType2(Context context, List<MDStore> results) {
