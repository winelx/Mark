 ...
 */
public class MDRecycleItemAdapterType3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<MDNewGoods> results;

    //get & set
    public List<MDNewGoods> getResults() {
        return results;
    }
    ...
    public MDRecycleItemAdapterType3(Context context, List<MDNewGoods> results) {
